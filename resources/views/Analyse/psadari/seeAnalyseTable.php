<table  id="powerballLogBox" class="powerballBox table table-bordered mt-2">
    ...
    <thead class="border-jinblue jin-gradient">
        <tr>
            <th height="30" colspan="12"  style="position: relative;">
                회차별 분석 데이터
            </th>
        </tr>
    </thead>
    <tbody class="see-t">
        ...
        <tr class="thirdTitle">
            ...
            <td>구간</td>
            <td>홀짝</td>
            <td data-hasqtip="276" oldtitle="기준:4.5" title="" aria-describedby="qtip-276">언더/오버</td>
            <td>결과</td>
            <td>합</td>
            <td>구간</td>
            <td>대/중/소</td>
            <td>홀짝</td>
            <td data-hasqtip="282" oldtitle="기준:72.5" title="">언더/오버</td>
        </tr>
    </tbody>
</table>
