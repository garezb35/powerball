                        ...
                        @foreach($result["list"] as $mail)
                            ...
                            <tr>
                                ...
                                @if($mail["received_usr"]["isDeleted"] == 1 || $mail["received_usr"]["user_type"] == "00")
                                    ...
                                    <strong>{{$mail["received_usr"]["nickname"]}}</strong>
                                </td>
                                <td class="left"><a href="{{"memo"}}?type=memoView&mtype=send&mid={{$mail["id"]}}" class="{{$read}}">
                                ...
                                <td class="{{$read}}">@if(!empty($mail["view_date"])){{date("m-d H:i",strtotime($mail["view_date"]))}}@endif</td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
