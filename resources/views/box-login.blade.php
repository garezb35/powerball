        ...
        <table class="table box-menus mar-t-5 mb-0">
            ...
            <tr>
                <td colspan="4" class="back-blue simu-head">
                    ...
                    @if(!empty($using_sim) && !empty($using_sim->format("%a")))
                    <span class="font-weight-bold text-white align-middle ll-he23">남은 기간</span>  <span class="text-gold font-weight-bold align-middle ll-he23">{{$using_sim->format("%a")}}일</span>
