...
@section("content")
    ...
    <div class="dateInfo">
        ...
        <div class="btnBox">
            <ul class="switch_tab" style="margin-top: 25px;">
                <li><a class="selected" href="/p_analyse?terms=date">하루씩 보기</a></li>
                <li><a  href="/p_analyse?terms=period&dateType=15">기한으로 보기</a></li>
            </ul>
            <a class="btn_refresh" id="btn_refresh" href="javascript:location.reload();" title="새로고침" style="margin-top: 17px;"><span class="ic">새로고침</span></a>
        </div>
{{--        @include("Time.timebox")--}}
    </div>
