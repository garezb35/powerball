                ...
                @if(empty($matches[$index][3][0]))
                    ...
                    <tr>
                        <td class="align-middle text-center">
                            ...
                            <input type="hidden" id="oppo30" value="{{'0'}}">
                        </td>
                        <td class="align-middle text-center"></td>
                        <td class="align-middle text-center"></td>
                        <td class="align-middle text-center p-0">
                            <a class="zulbtn" onclick="changeRow(this,30)">{{'줄'}}</a>
                        </td>
                    </tr>
                @endif
                @if(!empty($matches[$index][3][0]))
                    <tr>
                        <td colspan="4" class="p-0">
                            <input type="text" class="form-control pattern-input3" placeholder="xxxxx/xxxxx/xxxxx/xxxxx/xxxxx" value="{{$matches[$index][3][0]["auto_pattern"]}}">
                        </td>
                    </tr>
                    <tr class="green-back">
                        <td class="text-center">최종단계</td>
                    ...
                    <tr>
                        <td class="align-middle text-center">
                            <input type="number" value="{{$matches[$index][3][0]["auto_last_step"]}}" class="pattern-step3 form-control-custom" min="1" max="30"> 단
                            <input type="hidden" id="oppo30" value="{{$matches[$index][3][0]["auto_oppo"]}}">
                        </td>
                        <td class="align-middle text-center">{{$matches[$index][3][0]["auto_step"]+1}}단</td>
                        <td class="align-middle text-center">{{number_format($mny[$matches[$index][3][0]["auto_step"]])}}원</td>
                        <td class="align-middle text-center p-0">
                            <a class="zulbtn" onclick="changeRow(this,30)">{{$zu[$matches[$index][3][0]["auto_oppo"]]}}</a>
                        </td>
                    </tr>
                @endif
                </tbody>
