                              ...
                              <tr>
                                <td class="pl-0">
                                  <div class="input-group input-group-sm mb-1">
                                    ...
                                    <input type="number" min="0" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="win_limit" value="{{$win_limit}}">
                                  </div>
                              </td>
                                <td  class="pl-0">
                                  <div class="input-group input-group-sm mb-1">
                                    ...
                                    <input type="number" min="0" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="lost_limit" value="{{$lost_limit}}">
                                  </div>
                                </td>
                              </tr>
                            </tbody>
