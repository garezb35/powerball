<?php $__env->startSection("content"); ?>
    <div class="memoBox">
        ...
        <div class="content">
            ...
            <form name="memoForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="mtype" value="send" />
                    ...
                    <?php if(!empty(sizeof($result["list"]))): ?>
                        <?php $__currentLoopData = $result["list"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <img src="<?php echo e($mail["received_usr"]["getLevel"]["value3"]); ?>" width="23" height="23">
                                <?php if($mail["received_usr"]["isDeleted"] == 1 || $mail["received_usr"]["user_type"] == "00"): ?>
                                            <span style="position:absolute;left:0;z-index:99;">
                                    <img src="/assets/images/powerball/prison.png" width="23" height="23">
                                </span>
                                        <?php endif; ?>
                            </span>
                                    <strong><?php echo e($mail["received_usr"]["nickname"]); ?></strong>
                                </td>
                                <td class="left"><a href="<?php echo e("memo"); ?>?type=memoView&mtype=send&mid=<?php echo e($mail["id"]); ?>" class="<?php echo e($read); ?>">
                                ...
                                <td class="<?php echo e($read); ?>"><?php if(!empty($mail["view_date"])): ?><?php echo e(date("m-d H:i",strtotime($mail["view_date"]))); ?><?php endif; ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <tr>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\xampp8.0\htdocs\powerball\resources\views/member/memo1.blade.php ENDPATH**/ ?>