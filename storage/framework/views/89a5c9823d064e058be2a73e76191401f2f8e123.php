...
unset($__errorArgs, $__bag); ?>" name="smsAuthNum" value="<?php echo e(old('smsAuthNum')); ?>" required autocomplete="phoneNumber" autofocus
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="footer">
                        <p>이미 몬스터파워볼 회원이세요? <a href="<?php echo e(route('login')); ?>" class="text-blue">로그인하기</a></p>
                    </div>
                </div>
            </div>
        </div>
