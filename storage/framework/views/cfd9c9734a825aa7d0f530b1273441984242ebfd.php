    ...
    <div class="content">
        ...
        <ul class="itemList">
            <?php if(!empty($pur_item)): ?>
                ...
                <li>
                    <img src="<?php echo e($item->items->image); ?>" width="115" height="100">
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\xampp8.0\htdocs\powerball\resources\views/member/powerball-item.blade.php ENDPATH**/ ?>