                        ...
                        <?php $__currentLoopData = $result["list"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <?php endif; ?>
                                    ...
                                    <strong><?php echo e($mail[$sed_rec_key]["nickname"]); ?></strong>
                                </td>
                                <td class="left"><a href="<?php echo e("memo"); ?>?type=memoView&mid=<?php echo e($mail["id"]); ?>&mtype=<?php echo e($mtype); ?>" class="<?php echo e($read); ?>">
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\xampp8.0\htdocs\powerball\resources\views/member/memo2.blade.php ENDPATH**/ ?>