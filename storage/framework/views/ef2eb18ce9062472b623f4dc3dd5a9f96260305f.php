                            ...
                            <?php if(sizeof($result["list"]) > 0): ?>
                                <?php $__currentLoopData = $result["list"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $frd_usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td style="text-align:left;"><img src="<?php echo e($frd_usr["getLevel"]["value3"]); ?>" width="30" height="30"> <strong><?php echo e($frd_usr["nickname"]); ?></strong></td>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\powerball\resources\views/member/friendList.blade.php ENDPATH**/ ?>