...
<?php $__env->startSection("content"); ?>
  <script>
    ...
    var last = new Array();
    <?php if(!empty($last)): ?>
    last = <?php echo e(json_encode($last,JSON_PRETTY_PRINT)); ?>;
    <?php endif; ?>
  </script>
...
<?php echo $__env->make("Analyse.winning", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make("Analyse.bar_graph", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<style>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\powerball\resources\views/pick/winning.blade.php ENDPATH**/ ?>