<script>
    ...
    var board_category = "<?php echo e(Request::get("board_category")); ?>";
</script>
<?php $__env->startSection("header"); ?>
    <script src="/assets/js/wrest.js"></script>
    <section id="bo_w">
        <h2 id="container_title"><?php echo e($result["board"]["content"]); ?> 글쓰기</h2>
        <form name="fwrite" id="fwrite" action="/writePost" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:100%">
            ...
            <input type="hidden" name="rid" value="<?php echo e(Request::get("rid")); ?>">
            <input type="hidden" name="reply" value="<?php echo e(Request::get("reply")); ?>">
                        ...
                        <tr>
                            <td>
                                <div id="autosave_wrapper">
                                    <input type="text" name="wr_subject" value="<?php echo e($result["title"]); ?>" id="wr_subject" class="frm_input" size="50" maxlength="255">
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <div class="btn_confirm">
                ...
                <a href="/board?board_type=<?php echo e(Request::get("board_type")); ?>&board_category=<?php echo e(Request::get("board_category")); ?>" class="btn_cancel">취소</a>
            </div>
        </form>
    </section>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\xampp8.0\htdocs\powerball\resources\views/board_write.blade.php ENDPATH**/ ?>