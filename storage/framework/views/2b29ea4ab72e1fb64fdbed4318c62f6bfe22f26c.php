        ...
        <div class="memberInfoBox">
            <form name="memberForm" method="post" action="/exitMember" >
                ...
                <div style="margin-top:10px;text-align:center;font-size:11px;">
                    ...
                    회원정보 및 코인, 당근 등 서비스 기록이 모두 삭제되며, 삭제된 데이터는 복구되지 않습니다.<br>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp1\htdocs\powerball\resources\views/member/powerball-withdraw.blade.php ENDPATH**/ ?>