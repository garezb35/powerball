                              ...
                              <tr>
                                ...
                                <td class="border-top-none border-left-none align-middle" style="padding-left:10px">패턴옵션 :
                                  <div class="form-check-inline">
                                   ...
                                   <?php if(!empty($matches[1][$index][0]) && $matches[1][$index][0]["auto_cate"] == 1): ?><?php echo e("checked"); ?><?php endif; ?>
                                    >
                                  ...
                                  <div class="form-check-inline">
                                    ...
                                    <?php if(!empty($matches[1][$index][0]) && $matches[1][$index][0]["auto_cate"] == 2): ?><?php echo e("checked"); ?><?php endif; ?>
                                    >
                                  ...
                                  <div class="form-check-inline">
                                    ...
                                    <?php if(!empty($matches[1][$index][0]) && $matches[1][$index][0]["auto_cate"] == 3): ?><?php echo e("checked"); ?><?php endif; ?>
                                    >
                              ...
                              <tr>
                                  ...
                                  <?php if(!empty($matches[1][$index][0])): ?>
                                      <td class="border-top-none border-left-none align-middle border-bottom-none scroll-td">
                                        ...
                                        <?php echo $matches[1][$index][0]["auto_pattern"]; ?>

                                         </div>
                                         <textarea class="d-none"  name="p1[]"><?php echo $matches[1][$index][0]["auto_pattern"]; ?></textarea>
                                      ...
                                      <td class="p-0 border-top-none border-right-none border-bottom-none">
                                        ...
                                        <div class="editor-text" contenteditable="true" spellcheck="false" style="width:100%;height:110px;resize: none;" data-class="amount1[]" data-pattern = "amount">
                                          <?php echo $matches[1][$index][0]["money"]; ?>

                                        </div>
                                        <textarea class="d-none"  name="amount1[]"><?php echo $matches[1][$index][0]["money"]; ?></textarea>
              ...
              <table class="table table-bordered table-gray table-pad autopattern" style="display:none">
                ...
                <col width = "25%"/>
                  ...
                  <?php for($i =0 ; $i < 4 ; $i++): ?>
                    ...
                    <?php if(!empty($matches[2][($i+1) * $index][0])): ?>
                    <tr class="pattern1">
                      <td>
                        <div class="editor-text" contenteditable="true" spellcheck="false" data-class="p2_<?php echo e($index); ?>_<?php echo e($i); ?>"><?php echo $matches[2][($i+1) * $index][0]["auto_pattern"]; ?></div>
                        <textarea class="d-none" name="p2_<?php echo e($index); ?>_<?php echo e($i); ?>"><?php echo $matches[2][($i+1) * $index][0]["auto_pattern"]; ?></textarea>
                      </td>
                    </tr>
                  <?php else: ?>
                    <tr class="pattern1">
