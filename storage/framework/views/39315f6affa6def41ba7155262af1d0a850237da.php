<ul class="nav nav-pills nav-fill poweeball-menu">
    ...
    <li class="nav-item">
        <a class="nav-link <?php if( Request::get('terms') =="period" || Request::get('terms') =="date"): ?> active <?php endif; ?>" href="/psadari_analyse?terms=date">일별분석</a>
    </li>
    <li class="nav-item">
...
<?php /**PATH D:\xampp1\htdocs\powerball\resources\views/Analyse/psadari/analyse-menu.blade.php ENDPATH**/ ?>