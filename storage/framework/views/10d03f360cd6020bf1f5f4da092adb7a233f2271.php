...
<div class="modifyBox">
    ...
    <form name="profileForm" id="profileForm" method="post" enctype="multipart/form-data" action="/uploadImage">
        <?php echo csrf_field(); ?>
        <input type="hidden" id="token" name="api_token" value="<?php echo e($user["api_token"]); ?>">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="realtive" colspan="2"><img src="<?php echo e($user["image"]); ?>" id="profileImgArea" style="width:150px;height:150px;border:1px solid #c8c8c8;margin-right:5px;"> <input type="file" name="profileImg" id="profileImg" accept="image/*" onchange="imgCheck()"></td>
                    </tr>
                    <tr>
...
<?php echo $__env->make('includes.empty_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\xampp8.0\htdocs\powerball\resources\views/member/profile-change.blade.php ENDPATH**/ ?>