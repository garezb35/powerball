        ...
        <div id="topArea">
            ...
            <div class="gnb">
                <ul>
                    ...
                    <li><a href="<?php echo e(route('pick-win')); ?>" target="mainFrame" rel="hidden" class="hiddenBorard">연승제조기<div class="border-half"></div></a></li>
                    <li><a href="<?php echo e("board"); ?>?board_type=community&board_category=offten" target="mainFrame" class="hiddenBorard">커뮤니티<div class="border-half"></div></a></li>
